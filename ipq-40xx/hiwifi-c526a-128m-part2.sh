...
sed -i '/<footer class=\"mobile-hide\">/a <a href=\"https:\/\/github.com\/liuzhongh\/Actions-OpenWrt\">Build by Liuzhongh<\/a>\/' feeds/luci/themes/luci-theme-argon/luasrc/view/themes/argon/footer.htm/luasrc/view/themes/argon/footer.htm
